...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final Okhttp4LibraryAccessors laccForOkhttp4LibraryAccessors = new Okhttp4LibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>okhttp4</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Okhttp4LibraryAccessors getOkhttp4() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForOkhttp4LibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class Okhttp4LibraryAccessors extends SubDependencyFactory {
        private final Okhttp4X2LibraryAccessors laccForOkhttp4X2LibraryAccessors = new Okhttp4X2LibraryAccessors(owner);

        public Okhttp4LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>okhttp4.x2</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Okhttp4X2LibraryAccessors getX2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForOkhttp4X2LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Okhttp4X2LibraryAccessors extends SubDependencyFactory {

        public Okhttp4X2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>x</b> with <b>com.squareup.okhttp3:okhttp4.12.0</b> coordinates and
