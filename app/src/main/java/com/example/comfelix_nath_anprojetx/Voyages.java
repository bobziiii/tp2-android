...
public class Voyages {
    ...
    public Voyages(int id, String nom_voyage, String description, String destination, String image_url, String type_de_voyage, String activites_incluses, double prix, List<Trip> trips) {
        this.id = id;
